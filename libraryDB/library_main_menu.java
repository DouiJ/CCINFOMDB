...
public class library_main_menu {

    public library_main_menu() {
    }
    ...
    public int menu() {
        ...
        while (true) {
            ...
            System.out.println("═══════════════════════════════════════════════════════════════");
            System.out.printf("   %-2s ➤ %-40s%n", "[1]", "Branch Management");
            System.out.printf("   %-2s ➤ %-40s%n", "[2]", "Employee Management");
            System.out.printf("   %-2s ➤ %-40s%n", "[3]", "Patron Management");
