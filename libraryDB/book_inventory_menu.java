        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    e.isbn = scanner.nextLine();
                    System.out.print("Title: ");
                    e.title = scanner.nextLine();
                    System.out.print("Genre: ");
                    e.genre = scanner.nextLine();
                    System.out.print("Price: ");
                    e.price = scanner.nextDouble();
                    scanner.nextLine();
                    System.out.print("Author First Name: ");
                    e.author_first_name = scanner.nextLine();
                    System.out.print("Author Last Name: ");
                    e.author_last_name = scanner.nextLine();
                ...
                case 6:
                    ...
                    e.inventory_id = scanner.nextLine();
                    System.out.print("ISBN: ");
                    e.isbn = scanner.nextLine();
                    System.out.print("Branch ID: ");
                    e.branch_id = scanner.nextLine();
