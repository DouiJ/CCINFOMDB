...
public class scrollwithbuttonsPanel extends JPanel {
    ...
    public scrollwithbuttonsPanel() {

        this.textBoxList = new ArrayList<>();
        this.setLayout(null);
        this.setBackground(Color.WHITE);

        JLabel label = new JLabel("LIST OF --");
        ...
        addButton.setFont(new Font("Bookman Old Style", Font.PLAIN, 8));
        addButton.setBounds(10, 300, 70, 50);
        ...
        deleteButton.setBounds(250, 300, 50, 50);
